...
import { STATUS_VALID_FOR_MS, writeHealthStatus } from "../engine/watchdog-health.mjs";
...
try {
  writeHealthStatus(join(WORK, "watchdog-health.json"), problems, new Date(), STATUS_VALID_FOR_MS);
} catch (error) {
